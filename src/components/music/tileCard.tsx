...
export default function TileCard({
    ...
    const fallbackSrc = discord && user_id
        ? `https://cdn.discordapp.com/embed/avatars/${discordDefaultAvatar(user_id)}.png`
        : '/img/music-placeholder.svg'
...
function discordDefaultAvatar(userId: string) {
    try {
